...
if (isset($_POST['submit'])) {
  ...
  mysqli_query($con, "INSERT INTO checklist(fondo, limpieza, credito, maquina, funcionamiento, cerraduras, idMaquinita, fallo, prueba_fallo, comentario_fallo, pieza, comentario_pieza) 
            VALUES ('$retirarFondo', '$limpieza', '$dejarCredito', '$resetearMaquina', '$revisarFuncionamiento', '$cerraduras', '$maquinitas', '$fallo', '$prueba', '$comentario_fallo', '$pieza', '$comentario_pieza')")
