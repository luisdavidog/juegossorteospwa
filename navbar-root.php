<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
    <div class="container-fluid text-white">
        ...
        <a class="navbar-brand text-white" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-airplane-engines-fill" viewBox="0 0 16 16">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white text-uppercase" href="../_regi5tr0/">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white text-uppercase" href="../_regi5tr0Ti3nd4/">
                        ...
                        Registra nueva tienda</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-white text-uppercase" href="../_consulta-reportes">
