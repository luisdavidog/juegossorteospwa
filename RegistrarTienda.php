  ...
  <body>
    ...
    <form action="RegistrarTienda.php" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="idMunicipio" placeholder="Escriba el id del municipio" name="idMunicipio">
        </div>
...
<?php
            ...
            mysqli_query($conexion,"INSERT INTO tienda(Tienda, idMunicipio) 
